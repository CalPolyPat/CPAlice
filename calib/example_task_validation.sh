...
if ! [ -f sanityhistos.root ] ; then
   error=1
   echo "Output file sanityhistos.root not found. Job FAILED !" >> stdout
   echo "Output file sanityhistos.root not found. Job FAILED !" >> stderr
fi
