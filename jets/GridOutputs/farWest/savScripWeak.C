void savScripWeak(){
    ...
    TH1D* histProj;    
    TString partSpe[7]={"Unknown", "Electron", "Muon", "Pion", "Kaon", "Proton", "Dueteron"};
    ...
    for(Int_t i=0; i<=MB->LastIndex();i++){
        ...
        if(strcmp(hist->GetName(),"fHistDPhi18Spe_MB")==0){
            for(Int_t j=0;j<7;j++){
                TH2F *hist2d = (TH2F*)MB->At(i)->Clone();
                histProj = hist2d->ProjectionX(Form("%s_%spy", hist->GetName(),partSpe[j].Data()), j, j+1);
                histProj->Draw();
                c1->Update();
                c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/%s.png", histProj->GetName()));
            }
            hist->Draw("colz");
        }
        ...
        if(hist->GetName()[5]=='E'&&hist->GetName()[6]=='M'&&hist->GetName()[7]=='C'){
            ...
            if(hist->GetName()[-4]=='6'){
                ...
                TLine *sigETop = new TLine(1.3, 0, 1.3, hist->GetMaximum());
            ...
            if(hist->GetName()[9]=='T'&&hist->GetName()[10]=='P'&&hist->GetName()[11]=='C'&&hist->GetName()[12]=='T'&&hist->GetName()[13]=='R'){            
                TF1* elecFit = new TF1("elecFit", "gaus", 0.2, 1.3);
                TF1* totalFit = new TF1("totalFit", "gaus(0)+expo(3)", 0.2, 1.3);

                if(hist->GetName()[19]=='1'){
                    TF1* hadFit = new TF1("hadFit", "gaus", 0.2, 1.3);
                    TF1* totalFit = new TF1("totalFit", "gaus(0)+gaus(3)+expo(6)", 0.2, 1.3);
                }

                totalFit->SetParName(0,"Scale_elecFit");
                totalFit->SetParName(1,"Mean_elecFit");
                totalFit->SetParName(2,"Sigma_elecFit");
                totalFit->SetParName(3,"ExpScale_hadCont");
                totalFit->SetParName(4,"ExpExp_hadCont");

                if(hist->GetName()[19]=='1'){
                    totalFit->SetParName(3,"Scale_hadFit");
                    totalFit->SetParName(4,"Mean_hadFit");
                    totalFit->SetParName(5,"Sigma_hadFit");
                    totalFit->SetParName(6,"ExpScale_hadCont");
                    totalFit->SetParName(6,"ExpExp_hadCont");
                }

                totalFit->SetParameter(0,10);
                totalFit->SetParameter(1,1);
                totalFit->SetParameter(2,.4);
                totalFit->SetParameter(3,1);
                totalFit->SetParameter(4,.1);
                ...
                Double_t purity = elecFit->Integral(0.8, 1.3)/totalFit->Integral(0.8, 1.3);
                cout<<purity<<"\n"<<hist->GetName()[19]<<"\n";
                elecFit->Draw("same");
                switch(hist->GetName()[19]){
                    case '1':
                    ...
                    purity_MB[0]=purity;
                    NElec_MB[0]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_MB[0]=totalFit->Integral(0.8, 1.3);
                    NSig_MB[0]=elecFit->Integral(0.8, 1.3);
                    hadFit->Draw("same");
                    break;
                    case '2':
                    //Fill 2.5 Gev point in TGraph
                    purity_MB[1]=purity;
                    NElec_MB[1]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_MB[1]=totalFit->Integral(0.8, 1.3);
                    NSig_MB[1]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '3':
                    //Fill 3.5 Gev point in TGraph
                    purity_MB[2]=purity;
                    NElec_MB[1]=NElec_MB[1]+hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_MB[2]=totalFit->Integral(0.8, 1.3);
                    NSig_MB[2]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '4':
                    //Fill 4.5 Gev point in TGraph
                    purity_MB[3]=purity;
                    NElec_MB[2]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_MB[3]=totalFit->Integral(0.8, 1.3);
                    NSig_MB[3]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '5':
                    //Fill 5.5 Gev point in TGraph
                    purity_MB[4]=purity;
                    NElec_MB[2]=NElec_MB[2]+hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_MB[4]=totalFit->Integral(0.8, 1.3);
                    NSig_MB[4]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '>':
                    NElec6_MB = hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    break;
                }
            }
            if(hist->GetName()[9]=='H'){
        ...
        gStyle->SetOptFit(2);
        TLatex *   tex = new TLatex(0.4,.75,"#splitline{ALICE Work in Progress}{pp@8TeV}");
        tex->SetNDC();
        tex->SetTextFont(42);
        tex->Draw();
        c1->Update();
        c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/%s.png", hist->GetName()));
    ...
    sigBot->Draw();
    sigTop->Draw();
    TLatex *   tex = new TLatex(0.6,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCFull_MB.png"));
    c1->Clear();
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TRDFull_MB.png"));
    ...
    TLine *sigETop = new TLine(1.3, 0, 1.3, fHistEMC_1->GetMaximum());
    sigEBot->SetLineColor(kRed);
    sigETop->SetLineColor(kRed);
    sigEBot->SetLineWidth(2);
    sigETop->SetLineWidth(2);
    sigEBot->Draw();
    sigETop->Draw();
    TLatex *   tex = new TLatex(0.2,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();
    c1->cd(2);
    ...
    TLine *sigETop = new TLine(1.3, 0, 1.3, fHistEMC_2->GetMaximum());
    sigEBot->SetLineColor(kRed);
    sigETop->SetLineColor(kRed);
    sigEBot->SetLineWidth(2);
    sigETop->SetLineWidth(2);
    ...
    TLine *sigETop = new TLine(1.3, 0, 1.3, fHistEMC_3->GetMaximum());
    sigEBot->SetLineColor(kRed);
    sigETop->SetLineColor(kRed);
    sigEBot->SetLineWidth(2);
    sigETop->SetLineWidth(2);
    ...
    TLine *sigETop = new TLine(1.3, 0, 1.3, fHistEMC_4->GetMaximum());
    sigEBot->SetLineColor(kRed);
    sigETop->SetLineColor(kRed);
    sigEBot->SetLineWidth(2);
    sigETop->SetLineWidth(2);
    ...
    TLine *sigETop = new TLine(1.3, 0, 1.3, fHistEMC_5->GetMaximum());
    sigEBot->SetLineColor(kRed);
    sigETop->SetLineColor(kRed);
    sigEBot->SetLineWidth(2);
    sigETop->SetLineWidth(2);
    ...
    TLine *sigETop = new TLine(1.3, 0, 1.3, fHistEMC_6->GetMaximum());
    sigEBot->SetLineColor(kRed);
    sigETop->SetLineColor(kRed);
    sigEBot->SetLineWidth(2);
    sigETop->SetLineWidth(2);
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EMCFull_MB.png"));
    ...
    gPad->SetLogy();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EnergyOverlay_MB.png"));
    ...
    titl->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/InvMassOverlay_MB.png"));
    ...
    titl->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/OpAngOverlay_MB.png"));
    ...
    for(Int_t i=0; i<=EMC7->LastIndex();i++){
        ...
        if(strcmp(hist->GetName(),"fHistDPhi18Spe_EMC7")==0){
            for(Int_t j=0;j<7;j++){
                TH2F *hist2d = (TH2F*)EMC7->At(i)->Clone();
                histProj = hist2d->ProjectionX(Form("%s_%spy", hist->GetName(),partSpe[j].Data()), j, j+1);
                histProj->Draw();
                c1->Update();
                c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/%s.png", histProj->GetName()));
        ...
        if(strcmp(hist->GetName(),"fHistPtTag_EMC7")==0){
            gPad->SetLogy();
        }
        ...
        if(hist->GetName()[5]=='E'&&hist->GetName()[6]=='M'&&hist->GetName()[7]=='C'){
            ...
            if(hist->GetName()[9]=='T'&&hist->GetName()[10]=='P'&&hist->GetName()[11]=='C'&&hist->GetName()[12]=='T'&&hist->GetName()[13]=='R'){
                TF1* elecFit = new TF1("elecFit", "gaus", 0.2, 1.3);
                TF1* totalFit = new TF1("totalFit", "gaus(0)+expo(3)", 0.8, 1.3);
                ...
                if(hist->GetName()[21]=='1'){
                    ...
                    totalFit->SetParName(5,"Sigma_hadFit");
                    totalFit->SetParName(6,"ExpScale_hadCont");
                    totalFit->SetParName(7,"ExpExp_hadCont");
                }
                ...
                switch(hist->GetName()[21]){
                    ...
                    NElec_EMC7[0]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMC7[0]=totalFit->Integral(0.8, 1.3);
                    NSig_EMC7[0]=elecFit->Integral(0.8, 1.3);
                    hadFit->Draw("same");
                    break;
                    case '2':
                    //Fill 2.5 Gev point in TGraph
                    purity_EMC7[1]=purity;
                    NElec_EMC7[1]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMC7[1]=totalFit->Integral(0.8, 1.3);
                    NSig_EMC7[1]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '3':
                    //Fill 3.5 Gev point in TGraph
                    purity_EMC7[2]=purity;
                    NElec_EMC7[1]=NElec_EMC7[1]+hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMC7[2]=totalFit->Integral(0.8, 1.3);
                    NSig_EMC7[2]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '4':
                    //Fill 4.5 Gev point in TGraph
                    purity_EMC7[3]=purity;
                    NElec_EMC7[2]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMC7[3]=totalFit->Integral(0.8, 1.3);
                    NSig_EMC7[3]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '5':
                    //Fill 5.5 Gev point in TGraph
                    purity_EMC7[4]=purity;
                    NElec_EMC7[2]=NElec_EMC7[2]+hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMC7[4]=totalFit->Integral(0.8, 1.3);
                    NSig_EMC7[4]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '>':
                    NElec6_EMC7 = hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    break;
                }
            }
        }
    ...
    sigBot->Draw();
    sigTop->Draw();
    TLatex *   tex = new TLatex(0.5,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCFull_EMC7.png"));
    ...
    sigTRD->SetLineWidth(2);
    sigTRD->Draw();
    TLatex *   tex = new TLatex(0.5,0.5,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TRDFull_EMC7.png"));
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EMCFull_EMC7.png"));
    ...
    gPad->SetLogy();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EnergyOverlay_EMC7.png"));
    ...
    titl->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/InvMassOverlay_EMC7.png"));
    ...
    titl->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/OpAngOverlay_EMC7.png"));
    ...
    for(Int_t i=0; i<=EMCEGA->LastIndex();i++){
        ...
        gPad->SetLogz(0);
        hist->Draw("colz");
        if(strcmp(hist->GetName(),"fHistDPhi18Spe_EMCEGA")==0){
            for(Int_t j=0;j<7;j++){
                TH2F *hist2d = (TH2F*)EMCEGA->At(i)->Clone();
                histProj = hist2d->ProjectionX(Form("%s_%spy", hist->GetName(),partSpe[j].Data()), j, j+1);
                histProj->Draw();
                c1->Update();
                c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/%s.png", histProj->GetName()));
        ...
        if(strcmp(hist->GetName(),"fHistPtTag_EMCEGA")==0){
            gPad->SetLogy();
        }
        ...
        if(strcmp(hist->GetName(),"fHistInvMassElecLike_EMCEGA")==0){
            fHistPhotIML->Add(hist);
            fHistInvMassLike = fHistPhotIML;
        }
        if(strcmp(hist->GetName(),"fHistInvMassElecUnLike_EMCEGA")==0){
            fHistPhotIMU->Add(hist);
            fHistInvMassUnlike = fHistPhotIMU;
        }
        if(strcmp(hist->GetName(),"fHistOpAngElecLike_EMCEGA")==0){
            fHistPhotOAL->Add(hist);
            fHistOpAngLike = fHistPhotOAL;
        }
        if(strcmp(hist->GetName(),"fHistOpAngElecUnLike_EMCEGA")==0){
            fHistPhotOAU->Add(hist);
            fHistOpAngUnlike = fHistPhotOAU;
        }
        ...
        if(hist->GetName()[5]=='E'&&hist->GetName()[6]=='M'&&hist->GetName()[7]=='C'){
            ...
            if(hist->GetName()[9]=='T'&&hist->GetName()[10]=='P'&&hist->GetName()[11]=='C'&&hist->GetName()[12]=='T'&&hist->GetName()[13]=='R'){
                ...
                switch(hist->GetName()[23]){
                    ...
                    NElec_EMCEGA[0]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMCEGA[0]=totalFit->Integral(0.8, 1.3);
                    NSig_EMCEGA[0]=elecFit->Integral(0.8, 1.3);
                    hadFit->Draw("same");
                    break;
                    case '2':
                    //Fill 2.5 Gev point in TGraph
                    purity_EMCEGA[1]=purity;
                    NElec_EMCEGA[1]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMCEGA[1]=totalFit->Integral(0.8, 1.3);
                    NSig_EMCEGA[1]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '3':
                    //Fill 3.5 Gev point in TGraph
                    purity_EMCEGA[2]=purity;
                    NElec_EMCEGA[1]=NElec_EMCEGA[1]+hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMCEGA[2]=totalFit->Integral(0.8, 1.3);
                    NSig_EMCEGA[2]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '4':
                    //Fill 4.5 Gev point in TGraph
                    purity_EMCEGA[3]=purity;
                    NElec_EMCEGA[2]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMCEGA[3]=totalFit->Integral(0.8, 1.3);
                    NSig_EMCEGA[3]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '5':
                    //Fill 5.5 Gev point in TGraph
                    purity_EMCEGA[4]=purity;
                    NElec_EMCEGA[2]=NElec_EMCEGA[2]+hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    NTot_EMCEGA[4]=totalFit->Integral(0.8, 1.3);
                    NSig_EMCEGA[4]=elecFit->Integral(0.8, 1.3);
                    break;
                    case '>':
                    NElec6_EMCEGA = hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    break;
                }
            }
        }
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCFull_EMCEGA.png"));
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TRDFull_EMCEGA.png"));
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EMCFull_EMCEGA.png"));
    ...
    gPad->SetLogy();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EnergyOverlay_EMCEGA.png"));
    ...
    titl->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/InvMassOverlay_EMCEGA.png"));
    ...
    titl->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/OpAngOverlay_EMCEGA.png"));
    ...
    for(Int_t i=0; i<=EMCJet->LastIndex();i++){
        ...
        if(strcmp(hist->GetName(),"fHistDPhi18Spe_EMCJet")==0){
            for(Int_t j=0;j<7;j++){
                TH2F *hist2d = (TH2F*)EMCJet->At(i)->Clone();
                histProj = hist2d->ProjectionX(Form("%s_%spy", hist->GetName(),partSpe[j].Data()), j, j+1);
                histProj->Draw();
                c1->Update();
                c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/%s.png", histProj->GetName()));
        ...
        if(hist->GetName()[5]=='E'&&hist->GetName()[6]=='M'&&hist->GetName()[7]=='C'){
            ...
            if(hist->GetName()[9]=='T'&&hist->GetName()[10]=='P'&&hist->GetName()[11]=='C'&&hist->GetName()[12]=='T'&&hist->GetName()[13]=='R'){
                TF1* elecFit = new TF1("elecFit", "gaus", 0.8, 1.3);
                TF1* totalFit = new TF1("totalFit", "gaus(0)+pol0(3)", 0.8, 1.3);
                ...
                switch(hist->GetName()[23]){
                    ...
                    NElec_EMCJet[0]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    break;
                    case '2':
                    //Fill 2.5 Gev point in TGraph
                    purity_EMCJet[1]=purity;
                    NElec_EMCJet[1]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    break;
                    case '3':
                    //Fill 3.5 Gev point in TGraph
                    ...
                    NElec_EMCJet[2]=hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    break;
                    case '5':
                    //Fill 5.5 Gev point in TGraph
                    ...
                    break;
                    case '>':
                    NElec6_EMCJet = hist->Integral(hist->GetXaxis()->FindBin(0.8),hist->GetXaxis()->FindBin(1.3));
                    break;
                }
            }
        }
        ...
        gStyle->SetOptFit(2);
        TLatex *   tex = new TLatex(0.6,.86,"#splitline{ALICE Work in Progress}{pp@8TeV}");
        tex->SetNDC();
        tex->SetTextFont(42);
        tex->Draw();
        c1->Update();
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCFull_EMCJet.png"));
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TRDFull_EMCJet.png"));
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EMCFull_EMCJet.png"));
    ...
    for(Int_t i=0;i<indMix;i++){
        ...
        if(Dp->Divide(DpM)){
            ...
            c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/Correlation_%d%s%d%s%d%s%.1f%s%.1f.png",i,"trig_pt",i<6?1:i<12?2:i<18?4:i<24?1:i<30?2:i<36?4:i<42?1:i<48?2:i<54?4:-1,"",i<6?2:i<12?4:i<18?8:i<24?2:i<30?4:i<36?8:i<42?2:i<48?4:i<54?8:-1, "assoc_pt", assopt[i%6], "", assopt[i%6+1]));
        }
    }

    Double_t ybins[7]={0.3,0.5,0.8,1,2,4,8};

    TH2F* corr3D = new TH2F("corr3D", "Correlation function", fHistDPhiMix[0]->GetNbinsX(), -TMath::Pi()/2, TMath::Pi()*3/2, 6,ybins);
    corr3D->SetStats(0);
    ...
    for(Int_t i=0;i<indMix;i++){
        ...
        for(Int_t j=0;j<Cor->GetNbinsX();j++){
            corr3D->SetBinContent(j, i%6+1, Cor->GetBinContent(j));
        }
        if(i%6==5){
            corr3D->Draw("lego2");
            TLatex *   tex = new TLatex(0.6,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
            ...
            tex->SetTextFont(42);
            tex->Draw();
            corr3D->SetTitle(Form("Correlation Function vs. assoc pt for trig pt %d%s%d;\\Delta\\phi[rad];Assoc. Pt", i<6?1:i<12?2:i<18?4:i<24?1:i<30?2:i<36?4:i<42?1:i<48?2:i<54?4:i<60?1:i<66?2:i<72?4:-1, "-", i<6?2:i<12?4:i<18?8:i<24?2:i<30?4:i<36?8:i<42?2:i<48?4:i<54?8:i<60?2:i<66?4:i<72?8:-1));
            c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/Correlation3D_%d%s%d%s%d%s%.1f%s%.1f.png",i,"trig_pt",i<6?1:i<12?2:i<18?4:i<24?1:i<30?2:i<36?4:i<42?1:i<48?2:i<54?4:i<60?1:i<66?2:i<72?4:-1,"",i<6?2:i<12?4:i<18?8:i<24?2:i<30?4:i<36?8:i<42?2:i<48?4:i<54?8:i<60?2:i<66?4:i<72?8:-1, "assoc_pt", assopt[(i/6)%6], "", assopt[(i/6)%6+1]));
        }
    }


    c1->Clear();
    c1=new TCanvas("c1", "Corr",1000, 500);

    c1->Divide(4,2);
    Int_t Offset=0;
    cout<<ind;
    for(Int_t i=0;i<=(ind+Offset+8);i++){
        if(i<=ind+Offset+1){
            Int_t padnum=i%8+1;
            c1->cd(padnum);
            if(!fHistDPhiMix[i-Offset]){cout<<"no Mix"<<'\n'; continue;}
            DpM=(TH1F*)fHistDPhiMix[i-Offset];
            DpM->Scale(1/DpM->GetBinContent(DpM->FindBin(0))); 
            Dp=(TH1F*)fHistDPhi[i-Offset]->Clone("Dp");
            if(Dp->Divide(DpM)){
                Cor=Dp;
                Cor->SetStats(0);
                Cor->SetTitle(";\\Delta\\phi[rad];\\frac{N_{same}}{N_{mix}}\\frac{dN}{d\\phi}");
                Cor->GetXaxis()->SetTitleSize(0.06);
                Cor->GetYaxis()->SetTitleSize(0.06);
                if(i>=20&&i<41){
                    fHistCorrEGA7[i-20]=Cor;
                }
                if(i>=41&&i<62){
                    fHistCorrEGA7[i-41]->Add(Cor);
                }
                if(i%8+1!=8){
                    Cor->Draw("");
                    TLatex *   tex = new TLatex(0.36,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
                    tex->SetNDC();
                    tex->SetTextFont(42);
                    tex->Draw();
                    /*tite->Draw();*/
        ...
        if(i%8+1==8){
            Offset++;
            c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/Corr6_%d.png",i));
            /*title->Delete();*/
        }
    }

    c1->Clear();
    c1=new TCanvas("c1", "EGA7",1000, 500);
    c1->Divide(4,2);
    Int_t Offset=0;
    cout<<ind;
    for(Int_t i=0;i<=21+Offset;i++){
        Int_t padnum=i%8+1;
        c1->cd(padnum);
        cout<<i-Offset<<'\n';
        if(fHistCorrEGA7[i-Offset]){
            if(i%8+1!=8){
                fHistCorrEGA7[i-Offset]->Draw("");
                TLatex *   tex = new TLatex(0.36,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
                tex->SetNDC();
                tex->SetTextFont(42);
                tex->Draw();
        ...
        if(i%8+1==8){
            ...
            c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EGA7_%d.png",i));
        }
    }
    ...
    for(Int_t i=0;i<=(ind+Offset+1);i++){
        ...
        if(fHistDPhi[i-Offset]){
            ...
            /* TLatex* tite = new TLatex(-1.3, fHistDPhi[i-Offset]->GetMaximum()*1.1, Form("#Delta#phi for particles w/pt %s",ptRange[padnum-1].Data()));
            tite->SetTextSize(0.07);*/
            cout<<fHistDPhi[i-Offset]->GetName()<<'\n';
            if(i%8+1!=8){
                fHistDPhi[i-Offset]->Draw("");
                TLatex * tex = new TLatex(0.36,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
                tex->SetNDC();
                tex->SetTextFont(42);
                tex->Draw();
        ...
        if(i%8+1==8){
            ...
            title->AppendPad();*/
            Offset++;
            c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/DPhi6_%d.png",i));
            /*title->Delete();*/
        }
    }
    ...
    gPad->SetLogy();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EnergyOverlay_EMCJet.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/InvMassOverlay_EMCJet.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/OpAngOverlay_EMCJet.png"));

    fHistPhotIMU->SetFillStyle(3004);
    fHistPhotIMU->SetFillColor(kBlue);
    fHistPhotIMU->Draw();
    fHistPhotIML->SetFillStyle(3005);
    fHistPhotIML->SetFillColor(kRed);
    fHistPhotIML->SetLineColor(kRed);
    fHistPhotIML->Draw("same");
    TLine* InvCut = new TLine(.1, 0, .1, fHistPhotIMU->GetMaximum());
    InvCut->SetLineColor(kBlack);
    InvCut->SetLineWidth(2);
    InvCut->Draw();
    leg = new TLegend(0.3,0.7,0.6,0.9);
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/InvMassOverlay_EMCEGA7.png"));

    fHistPhotOAU->SetFillStyle(3004);
    fHistPhotOAU->SetFillColor(kBlue);
    fHistPhotOAU->Draw();
    fHistPhotOAL->SetFillStyle(3005);
    fHistPhotOAL->SetFillColor(kRed);
    fHistPhotOAL->SetLineColor(kRed);
    fHistPhotOAL->Draw("same");
    TLine* OpCut = new TLine(.1, 0, .1, fHistPhotOAU->GetMaximum());
    OpCut->SetLineColor(kBlack);
    OpCut->SetLineWidth(2);
    OpCut->Draw();
    leg = new TLegend(0.3,0.7,0.6,0.9);
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/OpAngOverlay_EMCEGA7.png"));
    ...
    fHistEMC_24->SetTitle("E/p for electrons with 2GeV<pt<3GeV;E/p[c^2];Cts");
    fHistEMC_24->SetStats(0);
    fHistEMC_24->Fit(totalFit, "B");
    elecFit->SetParameters(totalFit->GetParameters());
    fHistEMC_24->Draw();
    elecFit->SetLineColor(kOrange);
    elecFit->Draw("same");
    TLatex * tex = new TLatex(0.15,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EGA7_24.png"));

    fHistEMC_48->SetTitle("E/p for electrons with 4GeV<pt<5GeV;E/p[c^2];Cts");
    fHistEMC_48->SetStats(0);
    fHistEMC_48->Fit(totalFit, "B");
    elecFit->SetParameters(totalFit->GetParameters());
    fHistEMC_48->Draw();
    elecFit->SetLineColor(kOrange);
    elecFit->Draw("same");
    tex = new TLatex(0.15,0.8,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/EGA7_48.png"));

    gStyle->SetOptStat(1);

    Double_t x[5]={1.5, 2.5, 3.5, 4.5, 5.5};
    Double_t x4[4]={2.5, 3.5, 4.5, 5.5};
    ...
    Double_t purityErr_EMCEGA[4] = {(1/(NTot_EMCEGA[1]+NTot_EMC7[1]))*TMath::Sqrt((NSig_EMCEGA[1]+NSig_EMC7[1])*(1-(NSig_EMCEGA[1]+NSig_EMC7[1])/(NTot_EMCEGA[1]+NTot_EMC7[1]))), 
                                    (1/(NTot_EMCEGA[2]+NTot_EMC7[2]))*TMath::Sqrt((NSig_EMCEGA[2]+NSig_EMC7[2])*(1-(NSig_EMCEGA[2]+NSig_EMC7[2])/(NTot_EMCEGA[2]+NTot_EMC7[2]))),
                                    (1/(NTot_EMCEGA[3]+NTot_EMC7[3]))*TMath::Sqrt((NSig_EMCEGA[3]+NSig_EMC7[3])*(1-(NSig_EMCEGA[3]+NSig_EMC7[3])/(NTot_EMCEGA[3]+NTot_EMC7[3]))),
                                    (1/(NTot_EMCEGA[4]+NTot_EMC7[4]))*TMath::Sqrt((NSig_EMCEGA[4]+NSig_EMC7[4])*(1-(NSig_EMCEGA[4]+NSig_EMC7[4])/(NTot_EMCEGA[4]+NTot_EMC7[4])))
                                   };
    for(Int_t i=0;i<5;i++){
    ...
    Double_t EGA7[4] = {(NSig_EMCEGA[1]+NSig_EMC7[1])/(NTot_EMCEGA[1]+NTot_EMC7[1]), (NSig_EMCEGA[2]+NSig_EMC7[2])/(NTot_EMCEGA[2]+NTot_EMC7[2]), (NSig_EMCEGA[3]+NSig_EMC7[3])/(NTot_EMCEGA[3]+NTot_EMC7[3]), (NSig_EMCEGA[4]+NSig_EMC7[4])/(NTot_EMCEGA[4]+NTot_EMC7[4])};

    Double_t xpur[5]={0,0,0,0,0};

    Double_t xpur4[4]={0,0,0,0};
    ...
    TGraphErrors* purityGraph_EMCEGA = new TGraphErrors(4, x4, EGA7, xpur4, purityErr_EMCEGA);
    ...
    pMiss->GetYaxis()->SetTitle("# of misidentified e+-/# of triggers");
    pMiss->SetTitle("");
    pMiss->GetXaxis()->SetLabelOffset(999);
    pMiss->GetXaxis()->SetLabelSize(0);
    pMiss->SetMinimum(0);
    pMiss->SetMaximum(.1);
    pMiss->SetMarkerStyle(20);
    pMiss->Draw("Ape");
    TLatex *   tex = new TLatex(0.5,0.7,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();
    c1->Update();
    c1->SaveAs("./plotsKlayWeakNoSSNoSig/PhotonicMissGraph.png");
    ...
    TLatex *   tex = new TLatex(0.2,0.3,"#splitline{ALICE Work in Progress}{pp@8TeV}");
    tex->SetNDC();
    tex->SetTextFont(42);
    tex->Draw();

    c1->Update();
    c1->SaveAs("./plotsKlayWeakNoSSNoSig/ElecPurity_MB.png");

    c1->SetGrid();
    purityGraph_EMC7->GetXaxis()->SetTitle("Pt[GeV/c^2]");
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs("./plotsKlayWeakNoSSNoSig/ElecPurity_EMC7.png");

    c1->SetGrid();
    purityGraph_EMCEGA->GetXaxis()->SetTitle("Pt[GeV/c^2]");
    purityGraph_EMCEGA->GetYaxis()->SetTitle("Electron purity");
    purityGraph_EMCEGA->Draw("Ap");
    purityGraph_EMCEGA->GetXaxis()->SetRangeUser(0,6);
    purityGraph_EMCEGA->SetTitle("EMCEGA+EMC7 Electron Purity after TPC, TRD, EMC cuts");
    ...
    tex->Draw();
    c1->Update();
    c1->SaveAs("./plotsKlayWeakNoSSNoSig/ElecPurity_EMCEGA.png");

    c1->SetGrid();
    purityGraph_EMCJet->Draw("A");
    c1->Update();
    c1->SaveAs("./plotsKlayWeakNoSSNoSig/ElecPurity_EMCJet.png");
    return;
}
