void savScripWeak(){
    ...
    TList *MB = (TList*)file->Get("Min-Bias_Weak_NoSS_Sig");
    TList *EMC7 = (TList*)file->Get("EMCal7_Weak_NoSS_Sig");
    TList *EMCEGA = (TList*)file->Get("EMCalEGA_Weak_NoSS_Sig");
    TList *EMCJet = (TList*)file->Get("EMCalJet_Weak_NoSS_Sig");
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCSigOverlay_MB.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCSigOverlay_EMC7.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCSigOverlay_EMCEGA.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakNoSSNoSig/TPCSigOverlay_EMCJet.png"));
