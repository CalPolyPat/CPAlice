void savScripWeak(){
   ...
   /* TList *TPC = (TList*)PID->FindObject("TPC");
    ...
    sigTop->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/TPCFull_MB.png"));
    c1->Clear();
    ...
    sigTRD->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/TRDFull_MB.png"));
    ...
    sigETop->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/EMCFull_MB.png"));
    ...
    fHistInvMassUnlike->SetMarkerColor(kBlack);
    fHistInvMassUnlike->SetMarkerStyle(kFullCircle);
    fHistInvMassUnlike->Draw("P");
    fHistInvMassLike->SetMarkerColor(kBlack);
    fHistInvMassLike->SetMarkerStyle(kOpenCircle);
    fHistInvMassLike->Draw("same P");
    ...
    fHistOpAngUnlike->SetMarkerStyle(kFullCircle);
    fHistOpAngUnlike->SetMarkerColor(kBlack);
    fHistOpAngUnlike->Draw("P");
    fHistOpAngLike->SetMarkerStyle(kOpenCircle);
    fHistOpAngLike->SetMarkerColor(kBlack);
    fHistOpAngLike->Draw("same P");
    ...
    sigTop->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/TPCFull_EMC7.png"));
    ...
    sigTRD->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/TRDFull_EMC7.png"));
    ...
    sigETop->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/EMCFull_EMC7.png"));
    ...
    sigTop->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/TPCFull_EMCJet.png"));
    ...
    sigTRD->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/TRDFull_EMCJet.png"));
    ...
    sigETop->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayWeakSS/EMCFull_EMCJet.png"));
    ...
    for(Int_t i=0;i<=(ind+Offset+1);i++){
        ...
        if(i%8+1==8){
            ...
            title->AppendPad();*/
            Offset++;
            c1->SaveAs(Form("./plotsKlayWeakSS/DPhi6_%d.png",i));
            /*title->Delete();*/
        }
    }
    ...
    Double_t purityErr_MB[5] = {purity_MB[0]*TMath::Sqrt(1/NTot_MB[0]+1/NSig_MB[0]-2*(cov_MB*cov_MB)/(NTot_MB[0]*NSig_MB[0])), purity_MB[1]*TMath::Sqrt(1/NTot_MB[1]+1/NSig_MB[1]-2*(cov_MB*cov_MB)/(NTot_MB[1]*NSig_MB[1])), purity_MB[2]*TMath::Sqrt(1/NTot_MB[2]+1/NSig_MB[2]-2*(cov_MB*cov_MB)/(NTot_MB[2]*NSig_MB[2])), purity_MB[3]*TMath::Sqrt(1/NTot_MB[3]+1/NSig_MB[3]-2*(cov_MB*cov_MB)/(NTot_MB[3]*NSig_MB[3])), purity_MB[4]*TMath::Sqrt(1/NTot_MB[4]+1/NSig_MB[4]-2*(cov_MB*cov_MB)/(NTot_MB[4]*NSig_MB[4]))};
    
    
    
    Double_t purityErr_EMC7[5] = {purity_EMC7[0]*TMath::Sqrt(1/NTot_EMC7[0]+1/NSig_EMC7[0]-2*(cov_EMC7*cov_EMC7)/(NTot_EMC7[0]*NSig_EMC7[0])), purity_EMC7[1]*TMath::Sqrt(1/NTot_EMC7[1]+1/NSig_EMC7[1]-2*(cov_EMC7*cov_EMC7)/(NTot_EMC7[1]*NSig_EMC7[1])), purity_EMC7[2]*TMath::Sqrt(1/NTot_EMC7[2]+1/NSig_EMC7[2]-2*(cov_EMC7*cov_EMC7)/(NTot_EMC7[2]*NSig_EMC7[2])), purity_EMC7[3]*TMath::Sqrt(1/NTot_EMC7[3]+1/NSig_EMC7[3]-2*(cov_EMC7*cov_EMC7)/(NTot_EMC7[3]*NSig_EMC7[3])), purity_EMC7[4]*TMath::Sqrt(1/NTot_EMC7[4]+1/NSig_EMC7[4]-2*(cov_EMC7*cov_EMC7)/(NTot_EMC7[4]*NSig_EMC7[4]))};
    for(Int_t i=0;i<5;i++){
        cout<<1/NTot_EMC7[0]+1/NSig_EMC7[0]-2*(cov_EMC7*cov_EMC7)/(NTot_EMC7[0]*NSig_EMC7[0])<<'\n';
    }
    
    Double_t data[3]={MB_mis/NElecSum_MB, EMC7_mis/NElecSum_EMC7, 0/*EMCJet_mis/NElecSum_EMCJet*/};
    ...
    TGraphErrors* purityGraph_MB = new TGraphErrors(5, x, purity_MB, purityErr_MB);
    TGraphErrors* purityGraph_EMC7 = new TGraphErrors(5, x, purity_EMC7, purityErr_EMC7);
    TGraphErrors* purityGraph_EMCJet = new TGraphErrors(5, x, purity_EMCJet);
    TGraph* pMiss = new TGraph(3, y , data);
    ...
    pMiss->Draw("Ap");
    c1->Update();
    c1->SaveAs("./plotsKlayWeakSS/PhotonicMissGraph.png");
