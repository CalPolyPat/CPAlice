void savScripStrong(){
    ...
    TList *MB = (TList*)file->Get("Min-Bias_Strong");
    TList *EMC7 = (TList*)file->Get("EMCal7_Strong");
    TList *EMCJet = (TList*)file->Get("EMCalJet_Strong");
   ...
   /* TList *TPC = (TList*)PID->FindObject("TPC");
    ...
    TPCnSig->Draw("colz");
    c1->Update();
    c1->SaveAs("./plotsKlayStrong/TPCnSigmaRaw.png");
    ...
    for(Int_t i=0; i<=MB->LastIndex();i++){
        ...
        if(hist->GetName()[5]=='T'&&hist->GetName()[6]=='P'&&hist->GetName()[7]=='C'&&hist->GetName()[8]=='_'){
            ...
            sigBot->Draw();
            sigTop->Draw();
            TH1D *histProj = hist->ProjectionY(Form("%s_py", hist->GetName()));
        }
        ...
        if(hist->GetName()[5]=='E'&&hist->GetName()[6]=='M'&&hist->GetName()[7]=='C'){
            ...
            switch(hist->GetName()[19]){
                case '1':
                    ...
                    purity_MB[0]=purity;
                    NElec_MB[0]=totalFit->Integral(0.8, 1.2);
                    break;
                case '2':
                    //Fill 2.5 Gev point in TGraph
                    purity_MB[1]=purity;
                    NElec_MB[1]=totalFit->Integral(0.8, 1.2);
                    break;
                case '3':
                    //Fill 3.5 Gev point in TGraph
                    purity_MB[2]=purity;
                    NElec_MB[1]=NElec_MB[1]+totalFit->Integral(0.8, 1.2);
                    break;
                case '4':
                    //Fill 4.5 Gev point in TGraph
                    purity_MB[3]=purity;
                    NElec_MB[2]=totalFit->Integral(0.8, 1.2);
                    break;
                case '5':
                    //Fill 5.5 Gev point in TGraph
                    purity_MB[4]=purity;
                    NElec_MB[2]=NElec_MB[2]+totalFit->Integral(0.8, 1.2);
                    break;
            }
            }
            if(hist->GetName()[9]=='H'){
        ...
        gStyle->SetOptFit(2);
        c1->Update();
        c1->SaveAs(Form("./plotsKlayStrong/%s.png", hist->GetName()));
        
        
        histProj->Draw();
        c1->Update();
        c1->SaveAs(Form("./plotsKlayStrong/%s.png", histProj->GetName()));
    }
    ...
    gPad->SetLogy();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/EnergyOverlay_MB.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/InvMassOverlay_MB.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/OpAngOverlay_MB.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/TPCSigOverlay_MB.png"));
           ...
           if(hist->GetName()[-4]=='6'){
            ...
            switch(hist->GetName()[21]){
                case '1':
                    ...
                    NElec_EMC7[0]=totalFit->Integral(0.8, 1.2);
                    break;
                case '2':
                    //Fill 2.5 Gev point in TGraph
                    purity_EMC7[1]=purity;
                    NElec_EMC7[1]=totalFit->Integral(0.8, 1.2);
                    break;
                case '3':
                    //Fill 3.5 Gev point in TGraph
                    purity_EMC7[2]=purity;
                    NElec_EMC7[1]=NElec_EMC7[1]+totalFit->Integral(0.8, 1.2);
                    break;
                case '4':
                    //Fill 4.5 Gev point in TGraph
                    purity_EMC7[3]=purity;
                    NElec_EMC7[2]=totalFit->Integral(0.8, 1.2);
                    break;
                case '5':
                    //Fill 5.5 Gev point in TGraph
                    purity_EMC7[4]=purity;
                    NElec_EMC7[2]=NElec_EMC7[2]+totalFit->Integral(0.8, 1.2);
                    break;
            }
            }
        }
    ...
    gPad->SetLogy();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/EnergyOverlay_EMC7.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/InvMassOverlay_EMC7.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/OpAngOverlay_EMC7.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/TPCSigOverlay_EMC7.png"));
        ...
        if(hist->GetName()[5]=='E'&&hist->GetName()[6]=='M'&&hist->GetName()[7]=='C'){
            ...
            switch(hist->GetName()[23]){
                case '1':
                    ...
                    NElec_EMCJet[0]=totalFit->Integral(0.8, 1.2);
                    break;
                case '2':
                    //Fill 2.5 Gev point in TGraph
                    purity_EMCJet[1]=purity;
                    NElec_EMCJet[1]=totalFit->Integral(0.8, 1.2);
                    break;
                case '3':
                    //Fill 3.5 Gev point in TGraph
                ...
                case '4':
                    ...
                    NElec_EMCJet[2]=totalFit->Integral(0.8, 1.2);
                    break;
                case '5':
                    //Fill 5.5 Gev point in TGraph
    ...
    gPad->SetLogy();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/EnergyOverlay_EMCJet.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/InvMassOverlay_EMCJet.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/OpAngOverlay_EMCJet.png"));
    ...
    leg->Draw();
    c1->Update();
    c1->SaveAs(Form("./plotsKlayStrong/TPCSigOverlay_EMCJet.png"));
    ...
    c1->Update();
    c1->SaveAs("./plotsKlayStrong/ElecPurity_MB.png");
    ...
    c1->Update();
    c1->SaveAs("./plotsKlayStrong/ElecPurity_EMC7.png");
    
    c1->SetGrid();
    purityGraph_EMCJet->Draw("A*");
    c1->Update();
    c1->SaveAs("./plotsKlayStrong/ElecPurity_EMCJet.png");
    return;
}
