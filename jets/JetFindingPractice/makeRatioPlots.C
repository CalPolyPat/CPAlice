void makeRatioPlots(){
    ...
    histoName[0] = TString("AreaByPt");
    histoName[1] = TString("Pt");
    histoName[2] = TString("E");
    histoName[3] = TString("NchByPt");
    histoName[4] = TString("M");
    histoName[5] = TString("MaxChPtByPt");
    histoName[6] = TString("GirthByPt");
    histoName[7] = TString("QMomentByPt");
    histoName[8] = TString("CMomentByPt");
    histoName[9] = TString("Angularity");
    histoName[10] = TString("AngularityDeriv");
    histoName[11] = TString("LeadingPtFractionByPt");
